...
print("activate:")
print(urllib.request.urlopen(server + "activate/ff26d9e0-f5f6-4c9a-9d7a-2dcf618dfb09").read())
print("dump:")
print(urllib.request.urlopen(server + "dump/ff26d9e0-f5f6-4c9a-9d7a-2dcf618dfb09").read())
print("drop:")
print(urllib.request.urlopen(server + "drop/ff26d9e0-f5f6-4c9a-9d7a-2dcf618dfb09").read())
print("dump:")
print(urllib.request.urlopen(server + "dump/ff26d9e0-f5f6-4c9a-9d7a-2dcf618dfb09").read())
#print("activate2:")
